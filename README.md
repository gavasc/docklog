...
## What it does
Docklog watches all your running Docker containers and sends you a message whenever an error is logged. Perfect for monitoring low-usage containers where you want to be notified of issues without constantly checking logs.
